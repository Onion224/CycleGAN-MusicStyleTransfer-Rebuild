...
parser.add_argument('--batch_size', dest='batch_size', type=int, default=4, help='music in batch')
...
parser.add_argument('--transform', dest='transform', default='./transform', help='put the music that want to transfer')
...
music_dataset = MusicDataSet(
    A_dir_list=train_A_dir,
    B_dir_list=train_B_dir,
